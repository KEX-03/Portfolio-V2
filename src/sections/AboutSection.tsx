      ...
      <div className="section-card relative">
        ...
        <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          <motion.article
            ...
            className="relative rounded-[18px] border border-line bg-paper p-5 sm:p-6"
          >
          ...
          <motion.article
            ...
            className="relative rounded-[18px] border border-line bg-paper p-6 sm:p-8"
          >
            <h3 className="font-serif text-[clamp(2rem,4vw,3rem)] leading-[0.95] tracking-[-0.02em]">Designing with Code and Craft</h3>
