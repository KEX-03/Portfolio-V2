    ...
    <Section id="about" aria-label="About">
      <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        <motion.article
          ...
          className="paper-panel relative rounded-[22px] p-5 sm:p-6"
        >
          <span className="absolute -left-2 top-[-10px] h-[20px] w-[84px] -rotate-[7deg] bg-tape/85" />
          <div className="relative h-[280px] rounded-[14px] border border-line bg-[linear-gradient(135deg,rgba(25,21,17,0.85),rgba(25,21,17,0.55)),repeating-linear-gradient(45deg,#4a4a4a_0_6px,#2c2c2c_6px_12px)] p-4 sm:h-[320px]">
        ...
        <motion.article
          ...
          className="paper-panel relative rounded-[22px] p-6 sm:p-8"
        >
          <p className="font-mono text-[11px] uppercase tracking-[0.18em] text-muted">About</p>
          <h2 className="mt-3 font-serif text-[clamp(2rem,4vw,3rem)] leading-[0.95] tracking-[-0.02em]">Designing with Code and Craft</h2>
